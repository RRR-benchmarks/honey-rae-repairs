  ...
  return <form className="ticketForm">
            ...
            <fieldset>
                <div className="form-group">
                    ...
                    <input required autoFocus type="text" className="form-control" placeholder="Brief description of problem" value={ticket.description} onChange={evt => {
          const copy = {
            ...ticket
          };
          ...
          update(copy);
            ...
            <fieldset>
                <div className="form-group">
                    ...
                    <input type="checkbox" value={ticket.emergency} onChange={evt => {
          const copy = {
            ...ticket
          };
