...
export const EmployeeForm = () => {
  ...
  const handleSaveButtonClick = event => {
    ...
    return putUpdatedEmployeeProfile(profile).then(() => {
        ...
        <form className="profile">
            ...
            <fieldset>
                <div className="form-group">
                    ...
                    <input required autoFocus type="text" className="form-control" value={profile.specialty} onChange={evt => {
            const copy = {
              ...profile
            };
            ...
            <fieldset>
                <div className="form-group">
                    ...
                    <input type="number" className="form-control" value={profile.rate} onChange={evt => {
            const copy = {
              ...profile
            };
